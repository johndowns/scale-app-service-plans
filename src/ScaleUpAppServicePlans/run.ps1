...
foreach ($planSettings in $allPlanSettings)
{
    ...
    Set-AzAppServicePlan -Name $planSettings.Name -ResourceGroupName $planSettings.ResourceGroupName -Tier $planSettings.ScaleUp.Tier -WorkerSize $planSettings.ScaleUp.WorkerSize -NumberofWorkers $planSettings.ScaleUp.NumberOfWorkers
}
